...
lt.plugins.css.preprocess = (function preprocess(file_path,client_path,code){var matches = cljs.core.distinct.call(null,cljs.core.re_seq.call(null,lt.plugins.css.relative_url_pattern,code));var diff = lt.objs.files.relative.call(null,client_path,file_path);return cljs.core.reduce.call(null,(function (final$,p__8283){var vec__8284 = p__8283;var url_call = cljs.core.nth.call(null,vec__8284,0,null);var path = cljs.core.nth.call(null,vec__8284,1,null);return clojure.string.replace.call(null,final$,url_call,[cljs.core.str("url(\""),cljs.core.str(diff),cljs.core.str("/"),cljs.core.str(path),cljs.core.str("\")")].join(''));
}),code,matches);
});
...
lt.plugins.css.__BEH__eval_on_save = (function __BEH__eval_on_save(editor){if(cljs.core.truth_((function (){var and__6745__auto__ = new cljs.core.Keyword(null,"default","default",2558708147).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"client","client",3951159101).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,editor)));if(cljs.core.truth_(and__6745__auto__))
...
lt.plugins.css.__BEH__eval_BANG_ = (function __BEH__eval_BANG_(this$,event){var map__8287 = event;var map__8287__$1 = ((cljs.core.seq_QMARK_.call(null,map__8287))?cljs.core.apply.call(null,cljs.core.hash_map,map__8287):map__8287);var origin = cljs.core.get.call(null,map__8287__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));var info = cljs.core.get.call(null,map__8287__$1,new cljs.core.Keyword(null,"info","info",1017141280));var client = lt.objs.eval.get_client_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword(null,"editor.eval.css","editor.eval.css",1083014276),new cljs.core.Keyword(null,"origin","origin",4300251800),origin,new cljs.core.Keyword(null,"info","info",1017141280),info], null));var file_path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client_path = (function (){var G__8288 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,client));if(cljs.core._EQ_.call(null,"LT-UI",G__8288))
...
})();var code = ((cljs.core.not.call(null,client_path))?new cljs.core.Keyword(null,"code","code",1016963423).cljs$core$IFn$_invoke$arity$1(info):lt.plugins.css.preprocess.call(null,lt.objs.files.parent.call(null,file_path),client_path,new cljs.core.Keyword(null,"code","code",1016963423).cljs$core$IFn$_invoke$arity$1(info)));cljs.core.println.call(null,code);
return lt.objs.clients.send.call(null,client,new cljs.core.Keyword(null,"editor.eval.css","editor.eval.css",1083014276),cljs.core.assoc.call(null,info,new cljs.core.Keyword(null,"code","code",1016963423),code),new cljs.core.Keyword(null,"only","only",1017320222),origin);
});
